...
public abstract class Gossip extends Protocol implements Linkable
{
  ...
  public HashMap<Message,Long> sentMessages, receivedMessages;
  ...
  public Object clone()
  {
    ...
    gossip.sentMessages = (HashMap<Message,Long>)sentMessages.clone();
    gossip.receivedMessages = (HashMap<Message,Long>)receivedMessages.clone();
